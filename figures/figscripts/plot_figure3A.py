...
def avggene_riboshift_plot_overlay(alignposition, ribosome_site, experiment, fiveorthreeprime='5', normalizaiton='uneq', threshold ="0"):
...
def main():
	avggene_riboshift_plot_overlay(alignposition, ribosome_site, experiment, normalizaiton='eq', threshold=threshold)
